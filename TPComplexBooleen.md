...
Dans un carte plane, 4 couleurs suffisent pour colorier les zones sans que deux zones contiguent aient la même valeur.
 
...
Donnez le nb de clauses, lancer  la résolution
Il vous reste à lancer : 
