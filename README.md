...
- **très petits exemples pour comprendre les réseaux simples**
  ...
  - [DetectionAlertes.ipynb](https://github.com/EmmanuelADAM/IntelligenceArtificiellePython/blob/master/DetectionAlertes.ipynb)   : petit notebook python pour un exercie de détection très simple de messages douteux par réseaux de neurones
