...
class MonLunarLander(gym.Env, EzPickle):
    metadata = {
    ...
    def reset(self):
        ...
        self.lander.ApplyForceToCenter( ( 0,0 ), True)
...
class MonLunarLanderContinuous(MonLunarLander):
    continuous = True
...
if __name__ == '__main__':
    demo_heuristic_lander(MonLunarLander(), render=True)